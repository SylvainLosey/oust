...
class _ViewModel {
  ...
  static _ViewModel fromStore(Store<AppState> store) {
    return _ViewModel(
        ...
        floor: store.state.liftState.liftQuoteFormState.liftQuoteForm.floor,
        elevator: store.state.liftState.liftQuoteFormState.liftQuoteForm.elevator,
        note: store.state.liftState.liftQuoteFormState.liftQuoteForm.note,
